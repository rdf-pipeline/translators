/**
 * Translate cmumps Lab object to sd Observation.
 */
...
/**
 * IMPLEMENTATION NOT COMPLETE! Translate a cmumpsLabResultObject into a sd_Observation.
 * @param {object} cmumpsLabResultObject - javascript object with type 'chccs:Lab_Result-63'
 * @returns {object} -- sd translation
 * @see {http://hl7-sd.github.io/observation.html}
 *
...
function translateLabssd(cmumpsLabResultObject, options) {
    ...
    var fetch1 = fdt.makeJsonFetcher1(cmumpsLabResultObject, participatingProperties);
    // fetch1(json_pattern[, transformation])

    var identifier = fetch1('$.type', function (t) { return [ fdt.sdIdentifier(t) ]; }); // Identifier Id for external references to this report
    var patient = cmumpsLabResultObject['patient-63'];
    ...
    function clinical_chemistry(cc) {
        return fdt.clean({
            ...
            category: {coding: ['ch'], text: "Chemistry"}, // CodeableConcept, Service category, http://hl7-sd.github.io/valueset-diagnostic-service-sections.html
            code: fdt.required({}), // R!  Name/Code for this diagnostic report, loinc http://hl7-sd.github.io/valueset-report-codes.html
    ...
    function parasitology_buffer(pb) {
        ...
        return fdt.clean({
            ...
            category: {coding: ['par'], text: "Parasitology"}, // deprecated, CodeableConcept, Service category, http://hl7-sd.github.io/valueset-diagnostic-service-sections.html
            code: fdt.required({}), // R!  Name/Code for this diagnostic report, loinc http://hl7-sd.github.io/valueset-report-codes.html
    ...
    function bacteriology_buffer(bb) {
        return fdt.clean({
            ...
            category: {coding: ['oth'], text: "Other"}, // CodeableConcept, Service category, http://hl7-sd.github.io/valueset-diagnostic-service-sections.html
            code: fdt.required({}), // R!  Name/Code for this diagnostic report, loinc http://hl7-sd.github.io/valueset-report-codes.html
            subject: fdt.required(patient), // Reference(Patient|Group|Device|Location) R!  The subject of the report, usually, but not always, the patient
            encounter: {}, // Reference(Encounter) Health care event when test ordered
            // effective[x]: Clinically Relevant time/time-period for report. One of these 2:
    ...
    function mycobacterium_buffer(mb) {
        return fdt.clean({
            ...
            category: {coding: ['mcb'], text: "Mycobacteriology"}, // CodeableConcept, Service category, http://hl7-sd.github.io/valueset-diagnostic-service-sections.html
            code: fdt.required({}), // R!  Name/Code for this diagnostic report, loinc http://hl7-sd.github.io/valueset-report-codes.html
            subject: fdt.required(patient), // Reference(Patient|Group|Device|Location) R!  The subject of the report, usually, but not always, the patient
            encounter: {}, // Reference(Encounter) Health care event when test ordered
            // effective[x]: Clinically Relevant time/time-period for report. One of these 2:
    ...
    function mycology_buffer(mb) {
        return fdt.clean({
            ...
            category: {coding: ['myc'], text: "Mycology"}, // CodeableConcept, Service category, http://hl7-sd.github.io/valueset-diagnostic-service-sections.html
            code: fdt.required({}), // R!  Name/Code for this diagnostic report, loinc http://hl7-sd.github.io/valueset-report-codes.html
            subject: fdt.required(patient), // Reference(Patient|Group|Device|Location) R!  The subject of the report, usually, but not always, the patient
            encounter: {}, // Reference(Encounter) Health care event when test ordered
            // effective[x]: Clinically Relevant time/time-period for report. One of these 2:
    ...
    function virology_buffer(vb) {
        return fdt.clean({
            ...
            category: {coding: ['vr'], text: "Virology"}, // CodeableConcept, Service category, http://hl7-sd.github.io/valueset-diagnostic-service-sections.html
            code: fdt.required({}), // R!  Name/Code for this diagnostic report, loinc http://hl7-sd.github.io/valueset-report-codes.html
            subject: fdt.required(patient), // Reference(Patient|Group|Device|Location) R!  The subject of the report, usually, but not always, the patient
            encounter: {}, // Reference(Encounter) Health care event when test ordered
            // effective[x]: Clinically Relevant time/time-period for report. One of these 2:
    ...
    function surgical_pathology(sp) {
        return fdt.clean({
            ...
            category: {coding: ['sp'], text: "Surgical Pathology"}, // CodeableConcept, Service category, http://hl7-sd.github.io/valueset-diagnostic-service-sections.html
            code: fdt.required({}), // R!  Name/Code for this diagnostic report, loinc http://hl7-sd.github.io/valueset-report-codes.html
            subject: fdt.required(patient), // Reference(Patient|Group|Device|Location) R!  The subject of the report, usually, but not always, the patient
            encounter: {}, // Reference(Encounter) Health care event when test ordered
            // effective[x]: Clinically Relevant time/time-period for report. One of these 2:
    ...
    function cytology_gyn(cg) {
        return fdt.clean({
            ...
            category: {coding: ['cy'], text: "Cytogenetics"}, // CodeableConcept, Service category, http://hl7-sd.github.io/valueset-diagnostic-service-sections.html
            code: fdt.required({}), // R!  Name/Code for this diagnostic report, loinc http://hl7-sd.github.io/valueset-report-codes.html
            subject: fdt.required(patient), // Reference(Patient|Group|Device|Location) R!  The subject of the report, usually, but not always, the patient
            encounter: {}, // Reference(Encounter) Health care event when test ordered
            // effective[x]: Clinically Relevant time/time-period for report. One of these 2:
    ...
    function parasitology(p) {
        return fdt.clean({
            ...
            category: {coding: ['par'], text: "Parasitology"}, // CodeableConcept, Service category, http://hl7-sd.github.io/valueset-diagnostic-service-sections.html
            code: fdt.required({}), // R!  Name/Code for this diagnostic report, loinc http://hl7-sd.github.io/valueset-report-codes.html
            subject: fdt.required(patient), // Reference(Patient|Group|Device|Location) R!  The subject of the report, usually, but not always, the patient
            encounter: {}, // Reference(Encounter) Health care event when test ordered
            // effective[x]: Clinically Relevant time/time-period for report. One of these 2:
    ...
    var sdDiagnosticReports = [];
    // Take the cross product of all lab kinds, labKinds by their appearances in a Lab_Reports-63 object and
    // push their translations onto sdDiagnosticReports.
    labKinds.forEach(function(lk) {
        fetch1("$." + lk.name + '-63', function (l) {
            if (l) l.forEach(function(i) {
                sdDiagnosticReports.push(lk(i));
            });
        });
    });

    if (options.participants) sd.addParticipants(sdDiagnosticReports, participatingProperties);
    if (options.warnings) sd.addWarnings(sdDiagnosticReports, warnings);
    fdt.clean(sdDiagnosticReports);
    // Additional semantic processing here
    return sdDiagnosticReports;
}

var translate = translateLabssd;

// Export the actual functions here. Make sure the names are always consistent.
[translateLabssd, translate].forEach(function(f) { module.exports[f.name] = f; });
