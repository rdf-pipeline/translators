...
function translateLabsFhir(cmumpsLabResultObject, options) {
    ...
    var identifier = fetch1('$.type', function (t) { return [ fdt.fhirIdentifier(t) ]; }); // Identifier Id for external references to this report
    ...
    if (options.participants) fhir.addParticipants(fhirDiagnosticReports, participatingProperties);
