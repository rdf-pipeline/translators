// cmumps2fhir_diagnoses-mocha.js
...
describe("cmumps2fhir_diagnoses", function() {
    ...
    describe("#extractDiagnoses", function() {
        it("should throw an error if there is no JSON-LD data passed in", function() {
            expect(Diagnoses.extractDiagnoses).to.throw(Error, 
                "Cannot extract CMUMPS diagnoses because patient data object is undefined!");
        });
        ...
        it("should extract CMUMPS diagnoses", function() {
            ...
            results.forEach(function(diagResult) { 
                ...
                diagResult.type.should.equal('cmumpss:Kg_Patient_Diagnosis-100417');
    ...
    describe("#translateDiagnoses2Fhir", function() {
        ...
        it("should translate CMUMPS diagnoses to FHIR", function() {
            var cmumpsDiagnoses = Diagnoses.extractDiagnoses(patient7);

            var fhirResults = cmumpsDiagnoses.map(function(diagnosis) { 
