...
var lpi = require('../lpi');
var chcs2fhir_labs = require('../chcs2fhir_labs');
...
describe('for chcs-utils', function() {
    ...
    describe('the frontier (all can serve as examples)', function () {
        ...
        it('can have only values (example of chcs_utils.values())', function () {
            var theObject = {
                key0: {key1: 'key0.key1'},
                key2: {key3: 'key2.key3'},
                key4: {key5: {key6: 'key4.key5.key6'}}
        ...
        it('can only have keys (example of chcs_utils.keys())', function () {
        ...
        it('can find the value differences (example of chcs_utils.diffObjects())', function () {
            var theObject = {key0: {key1: 'key0.key1'}, key2: {key3: 'key2.key3'}, key4: {key5: {key6: 'key4.key5.key6'}}};
            var theDiff = chcs_utils.diffObjects(theObject, theObject);
            chai.expect(theDiff).to.have.length(0);
        });

        it('can find the value overlaps (example of chcs_utils.overlapObjects())', function () {
            var theObject = {key0: {key1: 'key0.key1'}, key2: {key3: 'key2.key3'}, key4: {key5: {key6: 'key4.key5.key6'}}};
...
describe('for lpi ...', function() {
    describe('lpi.Defer() ...', function() {
        it('can Defer a lab result translation as a Defer object', function () {
            var fhirTargetResource = chcs2fhir_labs.translateLabsFhir.resourceType; // each translator "knows" its FHIR result
            var translatorFunction = chcs2fhir_labs.translateLabsFhir;
            var sourceNode = 'tbs';
            var id = '63-0000007'; // chcss:Lab_Result-63
