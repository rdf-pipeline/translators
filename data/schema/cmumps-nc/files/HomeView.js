define([
	...
	displayDataset:function () {
		...
		$.getJSON('/dataset', function(datasets) {
			var html = '<table>';
			html += '<tr><th> Dataset </th><th> Description </th><th> Database </th><th> Derived </th><th> Schema </th><th> Date Created </th><th> Date Reloaded</th></tr>' ;
			datasets.forEach(function(dataset) {
				html += '<tr><td>' + dataset.name + '</td><td>' + dataset.description + '</td><td>' + dataset.database
                    + '</td><td>' + dataset.derived + '</td><td>' + dataset.schema + '</td><td>' + dataset.dateCreated
