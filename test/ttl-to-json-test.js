  ...
  describe("--ttlfile option", function() {
      ...
      it("should convert simple RDF file specified by -t to json successfully", function(done) {
          ...
          exec(command, function (error, stdout, stderr) {
              ...
              graph['@id'].should.equal("urn:local:patient-1");
              graph['http://hokukahu.com/schema/cmumpss#identifier'].should.equal("2-000007");
              graph['http://hokukahu.com/schema/cmumpss#phone-2'].should.equal("555 555 5555");
              graph['http://hokukahu.com/schema/cmumpss#street_address-2'].should.equal("100 MAIN ST");
              graph['http://hokukahu.com/schema/cmumpss#city-2'].should.equal("ANYTOWN");
              graph['http://hokukahu.com/schema/cmumpss#state-2'].should.equal("NEW YORK");
              graph['http://hokukahu.com/schema/cmumpss#zip_code-2'].should.equal("60040");
              graph['http://www.w3.org/2000/01/rdf-schema#label'].should.equal("BUNNY,BUGS");
              graph['http://hokukahu.com/schema/cmumpss#emergency_contact-2'].should.equal("RUNNAH, ROAD");
              graph['http://hokukahu.com/schema/cmumpss#ephone-2'].should.equal("555 555 5558");
              graph['http://hokukahu.com/schema/cmumpss#estreet_address-2'].should.equal("7000 InternalTest Boulevard");
              graph['http://hokukahu.com/schema/cmumpss#ecity-2'].should.equal("ALBUQUERQUE");
              graph['http://hokukahu.com/schema/cmumpss#ezip-2'].should.equal("55555");
              done();
          });
      });
  });
